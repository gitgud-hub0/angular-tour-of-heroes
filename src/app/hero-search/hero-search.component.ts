...
export class HeroSearchComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.heroes$ = this.searchTerms.pipe(
      ...
      // NOTE: Canceling a previous searchHeroes() Observable doesn't actually abort a pending HTTP request. Unwanted results are discarded before they reach your application code.    
    );
  }
}